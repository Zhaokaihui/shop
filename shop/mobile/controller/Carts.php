...
use shop\common\model\Carts as M;
use shop\common\model\UserAddress;
use shop\common\model\Payments;
/**
...
class Carts extends Base{
    ...
    */
	...
	public function settlement(){
		...
		//获取用户积分
		$user = model('users')->getFieldsById((int)session('tb_USER.userId'),'userScore');
		//计算可用积分和金额

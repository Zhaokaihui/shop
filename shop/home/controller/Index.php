...
class Index extends Base{
    ...
    public function index(){
        ...
        //获取用户积分
        $rs = model('Users')->getFieldsById((int)session('tb_USER.userId'),'userScore');
    ...
    public function position(){
        ...
        session('tb_MENID'.$menus['menuType'],$menus['parentId']);
    	session('tb_MENUID3'.$menuType,$menuId);
    }
    ...
    public function currenturl(){
    	session('tb_HO_CURRENTURL',input('url'));
    	return WSTReturn("", 1);
    }
}

<?php
namespace shop\home\model;
use shop\common\model\Suppliers as CSuppliers;
use shop\home\validate\Suppliers as VSupplier;
use shop\home\validate\SupplierBase as VSupplierBase;
use think\Db;
use think\Loader;
/**
 * * 门店类
...
class Suppliers extends CSuppliers{
    ...
    public function checkApply(){
        ...
        if(!empty($rs)){
            ...
            $tb_USER['tempSupplierId'] = $rs->supplierId;

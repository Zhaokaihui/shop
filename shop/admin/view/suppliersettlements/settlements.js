...
function initGrid(p){
    ...
    var cols = [
            {title:'供货商编号', name:'supplierSn', width: 130},
            {title:'供货商名称', name:'supplierName' ,width:100},
            {title:'店主姓名', name:'supplierkeeper', width: 130},
            ...
            {title:'操作', name:'' ,width:120, align:'center', renderer: function(val,item,rowIndex){
                var h = "<span id='s_"+item['supplierId']+"' dataval='"+item['supplierName']+"'></span><a class='btn btn-blue' href='javascript:toView(" + item['supplierId'] + ")'><i class='fa fa-search'></i>订单列表</a>&nbsp;&nbsp;";
	            return h;
            }}
            ];

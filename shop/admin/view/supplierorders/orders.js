...
function toView(id){
	location.href=WST.U('admin/supplierorders/view','id='+id+'&src=orders&p='+tb_CURR_PAGE);
}
...
function changeOrderStatus(id){
    location.href=WST.U('admin/supplierorders/changeOrderStatus','id='+id+'&p='+tb_CURR_PAGE);
}
function initChange(){
   var form = layui.form;

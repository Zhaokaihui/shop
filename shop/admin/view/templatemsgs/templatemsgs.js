...
function toEditMsg(id){
    location.href = WST.U('admin/templatemsgs/toEditMsg','id='+id+'&p='+tb_CURR_PAGE);
}
function toEditEmail(id){
    location.href = WST.U('admin/templatemsgs/toEditEmail','id='+id+'&p='+tb_CURR_PAGE);
}
function toEditSMS(id){
    location.href = WST.U('admin/templatemsgs/toEditSMS','id='+id+'&p='+tb_CURR_PAGE);
}

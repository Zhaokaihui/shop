...
function initSaleGrid(p){
    ...
    var cols = [
            ...
            {title:'操作', name:'' ,width:150, align:'center', renderer: function(val,item,rowIndex){
                var h = "";
	            h += "<a class='btn btn-blue' target='_blank' href='"+WST.U("admin/suppliergoods/detail","goodsId="+item['goodsId'])+"'><i class='fa fa-search'></i>查看</a> ";
...
function initAuditGrid(p){
    ...
    var cols = [
            ...
            {title:'操作', name:'' ,width:160, align:'center', renderer: function(val,item,rowIndex){
                var h = "";
	            h += "<a class='btn btn-blue' target='_blank' href='"+WST.U("admin/suppliergoods/detail","goodsId="+item['goodsId']+"&key="+item['verfiycode'])+"'><i class='fa fa-search'></i>查看</a> ";

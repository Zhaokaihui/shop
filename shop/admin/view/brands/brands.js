...
function toEditApply(id){
    location.href=WST.U('admin/brandapplys/toEdit','id='+id+'&p='+tb_CURR_PAGE);
}
...
function toEdit(id){
	location.href=WST.U('admin/brands/toEdit','id='+id+'&p='+tb_CURR_PAGE);
}

function toView(id){
    location.href=WST.U('admin/brands/toView','id='+id+'&p='+tb_CURR_PAGE);
}

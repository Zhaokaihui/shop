...
function initGrid(p){
    ...
    var cols = [
            ...
            {title:'操作', name:'' ,width:180, align:'center', renderer: function(val,item,rowIndex){
	            ...
	            h += "<a class='btn btn-blue' href='"+WST.U('admin/logmoneys/tologmoneys','id='+item['supplierId']+'&src=suppliers&p='+tb_CURR_PAGE)+"&type=3'><i class='fa fa-search'></i>供货商资金</a>";
	            return h;
            }}
            ];
...
function toHandle(id){
	location.href = WST.U('admin/suppliers/toHandleApply','id='+id+'&p='+tb_CURR_PAGE);
}
...
function toEdit(id,src){
	location.href=WST.U('admin/suppliers/toEdit','id='+id+'&p='+tb_CURR_PAGE+'&src='+src);
}

...
use shop\admin\validate\SupplierFlows as validate;
use shop\admin\validate\SupplierBase as ShopBaseValidate;
use think\Db;
/**
 * * * * * * * 店铺入驻流程业务处理
 */
    ...
    public function saveField(){
        ...
        try{
            ...
            if($data['id']!=0){
                ...
                // 如果属于tb_suppliers表，则不允许修改字段与字段属性
                // 如果属于tb_extras表的基础字段，也不允许修改字段与字段属性

...
use think\Db;
use shop\common\validate\SupplierOrderServices as Validate;
/**
 * * shop多买家商城
 * * *
 * * 售后业务处理类
...
class SupplierOrderServices extends Base{
    ...
    public function supplierSend(){
        ...
        $supplierId = (int)session('tb_SUPPLIER.supplierId');
    ...
    public function getLog($shopId=0){
        ...
        $userPhoto = session('tb_USER.userPhoto');
        $userName = session('tb_USER.loginName');

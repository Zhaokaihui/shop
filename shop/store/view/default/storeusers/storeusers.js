...
function toEdit(id){
	location.href = WST.U('store/storeusers/edit','id='+id+'&p='+tb_CURR_PAGE);
}
function toAdd(){
    location.href = WST.U('store/storeusers/add','p='+tb_CURR_PAGE);
}
function toNotify(id){
    location.href = WST.U('store/storeusers/notify','id='+id+'&p='+tb_CURR_PAGE);
}

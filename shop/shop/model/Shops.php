...
use shop\common\model\Shops as CShops;
use shop\shop\validate\Shops as VShop;
use think\Db;
use think\Loader;
/**
 * * 门店类
    ...
    */
    ...
    public function saveStep3($data = []){
        /*
            ...
            organizationCodeImg
        */
        $shopId = (int)session('tb_USER.tempShopId');
    ...
    public function renew(){
        ...
        try{
            ...
            if(false !== $shopRes && false !== $result){
                session('tb_USER.expireDate',$newExpireDate);
                Db::commit();

...
function toEdit(id){
	location.href = WST.U('shop/shopusers/edit','id='+id+'&p='+tb_CURR_PAGE);
}
function toAdd(){
    location.href = WST.U('shop/shopusers/add','p='+tb_CURR_PAGE);
}
function toNotify(id){
    location.href = WST.U('shop/shopusers/notify','id='+id+'&p='+tb_CURR_PAGE);
}

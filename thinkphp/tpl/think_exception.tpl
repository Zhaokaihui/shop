...
<body>
    ...
    <div class="copyright">
        <span style='color:#777;'><a style='text-decoration:none;color:#777;' title="官方网站" href="http://www.shop.net">shop</a> @ <a style='text-decoration:none;color:#777;' title="官方网站" href="http://www.shop.net">阳光软件</a> - 为创业赋能▪为电商加速</span> 
    </div>
    <?php if(\think\facade\App::isDebug()) { ?>
    <script>

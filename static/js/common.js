 ...
 * 获取版本
 */
WST.getshopVersion = function(url){
	$.post(url,{},function(data,textStatus){
	   ...
	   if(json){
		   if(json.version && json.version!='same'){
			   $('.shop-version-tips').show();
			   $('#shop_version').html(json.version);
			   $('#shop_down').attr('href',json.downloadUrl);
		   }
		   if(json.accredit=='no'){
			   $('.shop-accredit-tips').show();
		   }

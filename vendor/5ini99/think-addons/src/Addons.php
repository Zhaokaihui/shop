...
abstract class Addons{
    ...
    public function __construct()
    {
        ...
        $this->view->filter(function($content){
            ...
            $content = str_replace("__SHOP__",str_replace('/index.php','',$this->request->root()).'/shop/shop/view/default',$content);
            $content = str_replace("__STYLE__",str_replace('/index.php','',$this->request->root()).'/shop/home/view/'.WSTConf('CONF.wsthomeStyle'),$content);
            $content = str_replace("__ADMIN__",str_replace('/index.php','',$this->request->root()).'/shop/admin/view',$content);
            $content = str_replace("__WECHAT__",str_replace('/index.php','',$this->request->root()).'/shop/wechat/view/'.WSTConf('CONF.wstwechatStyle'),$content);
            $content = str_replace("__MOBILE__",str_replace('/index.php','',$this->request->root()).'/shop/mobile/view/default',$content);
            return $content;
        });
        // 控制器初始化
